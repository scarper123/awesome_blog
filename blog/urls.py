...
urlpatterns = [
    ...
    url(r'^author/$', views.category_list, name='category_list'),
    url(r'^author/add/$', views.author_add, name='author_add'),
    url(r'^author/delete/<?P([\d]+)>/$', views.category_delete, name='category_delete'),
    url(r'^author/update/<?P([\d]+)>/$', views.category_update, name='category_update'),
]
